...
Read [SKILL.md](SKILL.md) completely and follow its Select → Connect → Done flow for first-day setup, authentication, verification, troubleshooting, handover, and reset behavior.
...
- `scripts/WebAnalystSetup.ps1`: the resumable Connect action and advanced Windows recovery operations.
